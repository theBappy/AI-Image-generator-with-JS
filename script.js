...
const OPENAI_API_KEY =
  "lmwr_sk_GqU0LVxKgI_AEtEd6x0OI9GXBUmHmUZe0hVquI5nplU43qtt"; // Your OpenAI API key here
...
const generateAiImages = async (userPrompt, userImgQuantity) => {
  try {
    ...
    const response = await fetch(
      "https://limewire.com//data?api_key=lmwr_sk_GqU0LVxKgI_AEtEd6x0OI9GXBUmHmUZe0hVquI5nplU43qtt",
      {
        method: "POST",
        headers: {
  ...
  const imgCardMarkup = Array.from(
    ...
    () =>
      `<div class="img-card loading">
        <img src="images/loader.jpg" alt="AI generated image">
